...
import by.rudzko.likeit.controller.command.implementation.AddUserCommand;
import by.rudzko.likeit.controller.command.implementation.FindUserCommand;
import by.rudzko.likeit.controller.command.implementation.ShowUsersCommand;
...
public class CommandProvider {
    ...
    public String getJsp(String key) {
        return CommandName.valueOf(key.toUpperCase()).getJsp();
    }
}
